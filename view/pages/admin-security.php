            ...
            <div class="content-body ">
                ...
                <div class="accounts_section">
                    <div class="accounts_list_header">
                        <div class="accounts-info">
                            <h3>Security Members List</h3>
                            <p>View and manage registered Security members here.</p>
                        </div>
                        <a class="account-actions" href="../../view/pages/admin-add-student.php">
                            <button class="add-account" id='create-account-btn'>Add Security Member</button>
</a>
                ...
                <div class="accounts-list ">
                    <div class="searchbar ">
                       ...
                       <input type="search " name="search_std " id="search_std " placeholder="search " onkeyup="getStd(this.value,'security') " ">
                    </div>
                    <ul class="list-header ">
                        ...
                        <li>Name <span><img src="../images/dec.png " alt="sort " id="name-sort-dec " onclick="Asc('firstName','security') " ><img src="../images/asc.png " alt="sort " id="name-sort-asc " onclick="Desc('firstName','security') "></span>
                                    ...
                                    onclick="Asc('ID','security')"
                                    ><img src="../images/asc.png " alt="sort " id="id-sort-asc " 
                                    onclick="Desc('ID','security')"
                                    ></span></li>
                                    <li>Gender</li>
                                    ...
                                    <div class="list-content-container ">
                                        <?php 
$query = "SELECT * FROM user where user_type='security' ";
